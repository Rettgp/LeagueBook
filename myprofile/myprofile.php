            ...
            <div id="contentWrapper" class="flexi">
                ...
                <div id="content"><div class="col_menu" id="col_sidebar">
                        <div id="top_block_no_2"  ><div class="box_mid_ops"><div class="content" id="block_no_2">    <div class="menu_list">
                                        ...
                                        <a style="background-image: url(http://com/images/fugue/lock.png)"  href="http://lolcodex/homepage/change_password.php">Change Credentials</a>
                                        <a style="background-image: url(http://com/images/fugue/wall--pencil.png)"  href="http://LoLcodex.com/privacy_settings/privacysettings.php">Privacy Settings</a>
                                        <a style="background-image: url(http://com/images/fugue/mail--plus.png)"  href="http://lolcodex/homepage/composemessage.php">Compose New Message</a>
                                        <a style="background-image: url(http://com/images/fugue/mail--pencil.png)"  href="http://lolcodex/homepage/emailsettings.php">E-mail Settings</a>
                    ...
                    <div class="col_main_in_withmenubar">
                        <div id="top_block_no_1"  ><div class="box"><div class="box_top" id="block_title_no_1"><h2>Edit My Profile</h2></div><div style="clear:both"></div><div class="box_mid"><div class="content" id="block_no_1"></div><form method="post" class="siteForm" action="http://LoLcodex.com/myprofile/myprofile.php/myprofile.php" enctype="multipart/form-data" name="joinform" onsubmit="return _checkDate()"><div class="siteFormContainer">
                                            <div class="siteFormTitle">Name Surname</div>
                                            <div class="siteFormBody"><input type="text" name="name" value=<?PHP if($_SESSION['summoner'] == NULL) print "Please associate a Summoner name"; else print $_SESSION['summoner']; ?> class="medium" maxlength="50" /></div></div>
                                        <script>
                        ...
                        using the setFullYear function */
                                        ...
                                        <div class="siteFormContainer">
                                            ...
                                            <div class="siteFormBody">
                                                <div style="float: left;padding-right:5px"><img src="http://LoLcodex.com/avatars/b/80.png" /></div> <a href="javascript:void(0)" onclick="this.style.display='none';document.getElementById('xxxxn2').style.display='inline';">Upload new one...</a>
