...
<html dir="ltr">
<head>
<title>All Tournaments | LoLcodex</title>
	...
	<div id="contentWrapper" class="">
		<div id="aSide">
			<div id="userProfileBlock">
				<a href="http://LoLcodex.com/people/person/oajiivhbldxbldhwi"><img src="http://LoLcodex.com/avatars/b/80.png" alt="<?PHP if($_SESSION['summoner'] == NULL) print "Please associate a Summoner name"; ?>" width="50" height="50"></a>
				<h1><a href="http://LoLcodex.com/people/person/oajiivhbldxbldhwi"><?PHP if($_SESSION['summoner'] == NULL) print "Please associate a Summoner name"; ?></a></h1>
				<p>
					<a href="http://LoLcodex.com/people/person/oajiivhbldxbldhwi/edit">Edit Profile</a>
				</p>
			</div>
			<div id="menu">
				...
				<div id="top_block_no_1">
					<div class="box">
						<div class="box_top" id="block_title_no_1">
							<h2>Which Leagues Tournaments would you like to view?</h2>
						</div>
						<div style="clear:both">
						</div>
						<div class="box_mid">
							<div class="content" id="block_no_1">
								<table id="group_container" class="thumbnail_view">
								<tr>
									<td>
										<a href="../../../teams/SampleTeam/AllTourney/bronze/bronzebracket.php" title="Sample Group"><img alt="Sample Group" src="http://com//images/supgroup_def.png" width="80" height="80" class="tv_image"/><span class="tv_caption">Bronze League</a><span class="tv_info"><br>
										<a href="../../../teams/SampleTeam/AllTourney/bronze/bronzebracket.php"><strong>1</strong></a> Tournament(s)</span>
									</td>
								</tr>
								</table>
				...
				<div id="top_block_no_2">
					<div class="box">
						<div style="clear:both">
												...
												<div class="box_mid">
							<div class="content" id="block_no_2">
								<table id="group_container" class="thumbnail_view">
								<tr>
									<td>
										<a href="../../../teams/SampleTeam/AllTourney/silver/silverbracket.php" title="Sample Group"><img alt="Sample Group" src="http://com//images/supgroup_def.png" width="80" height="80" class="tv_image"/><span class="tv_caption">Silver League</a><span class="tv_info"><br>
										<a href="../../../teams/SampleTeam/AllTourney/silver/silverbracket.php"><strong>1</strong></a> Tournament(s)</span>
									</td>
								</tr>
								</table>
								<div style="display:none;">
					...
					<div id="top_block_no_3">
						<div class="box">
							<div style="clear:both">
							</div>
												<div class="box_mid">
							<div class="content" id="block_no_3">
								<table id="group_container" class="thumbnail_view">
								<tr>
									<td>
										<a href="../../../teams/SampleTeam/AllTourney/gold/goldbracket.php" title="Sample Group"><img alt="Sample Group" src="http://com//images/supgroup_def.png" width="80" height="80" class="tv_image"/><span class="tv_caption">Gold League</a><span class="tv_info"><br>
										<a href="../../../teams/SampleTeam/AllTourney/gold/goldbracket.php"><strong>1</strong></a> Tournament(s)</span>
									</td>
								</tr>
								</table>
								<div style="display:none;">
									...
									<div id="top_block_no_4">
					<div class="box">
						<div style="clear:both">
						</div>
												<div class="box_mid">
							<div class="content" id="block_no_4">
								<table id="group_container" class="thumbnail_view">
								<tr>
									<td>
										<a href="../../../teams/SampleTeam/AllTourney/platinum/platinumbracket.php" title="Sample Group"><img alt="Sample Group" src="http://com//images/supgroup_def.png" width="80" height="80" class="tv_image"/><span class="tv_caption">Platinum League</a><span class="tv_info"><br>
										<a href="../../../teams/SampleTeam/AllTourney/platinum/platinumbracket.php"><strong>1</strong></a> Tournament(s)</span>
									</td>
								</tr>
								</table>
								<div style="display:none;">
									...
									<div id="top_block_no_5">
					<div class="box">
						<div style="clear:both">
						</div>
												<div class="box_mid">
							<div class="content" id="block_no_5">
								<table id="group_container" class="thumbnail_view">
								<tr>
									<td>
										<a href="../../../teams/SampleTeam/AllTourney/diamond/diamondbracket.php" title="Sample Group"><img alt="Sample Group" src="http://com//images/supgroup_def.png" width="80" height="80" class="tv_image"/><span class="tv_caption">Diamond League</a><span class="tv_info"><br>
										<a href="../../../teams/SampleTeam/AllTourney/diamond/diamondbracket.php"><strong>1</strong></a> Tournament(s)</span>
									</td>
								</tr>
								</table>
								<div style="display:none;">
									...
									<div id="top_block_no_6">
					<div class="box">
						<div style="clear:both">
						</div>
												<div class="box_mid">
							<div class="content" id="block_no_6">
								<table id="group_container" class="thumbnail_view">
								<tr>
									<td>
										<a href="../../../teams/SampleTeam/AllTourney/challenger/challengerbracket.php" title="Sample Group"><img alt="Sample Group" src="http://com//images/supgroup_def.png" width="80" height="80" class="tv_image"/><span class="tv_caption">Challenger League</a><span class="tv_info"><br>
										<a href="../../../teams/SampleTeam/AllTourney/challenger/challengerbracket.php"><strong>1</strong></a> Tournament(s)</span>
									</td>
								</tr>
								</table>
								<div style="display:none;">
