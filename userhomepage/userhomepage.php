...
<?PHP
		...
		//setup();
		//PUT IN ANOTHER FILE AND CALL THAT PHP
		...
		if ($db_found) {*/
		/*$SQL = "SELECT summoner FROM users WHERE email = $_SESSION['acct']";
		$result = mysql_query($SQL);*/
		//IF SUMMONER NAME NOT SETUP
		/*echo '<script type="text/javascript">', 'summonerSetup();', '</script>';*/
		/*$( "#dialog-form" ).dialog({
				autoOpen: false,
				height: 300,
				width: 350,
            ...
            <div id="contentWrapper" class="">
                <div id="aSide">
                    <div id="userProfileBlock">
                        ...
                        <h1><a href="http://LoLcodex.com/people/person/oajiivhbldxbldhwi"><?PHP print $_SESSION['acct']; ?></a></h1>
                    ...
                    <ul id="groups_chat_user_list_g_leaguebook" class="chat_user_list">
                        <li id="panel_chat_user_13530230" class="vcard">
                            <a href="_trigger/chat/with/13530230" data-userid="13530230">
                                <img class="avatar" width="30" height="30" src="http://LoLcodex.com/avatars/b/80.png" alt="Levi Limmex's avatar">
