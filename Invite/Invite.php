...
<html dir="ltr">
    ...
    <body class="group_member">
        ...
        <div id="layout" class="module_dashboard spread">
            <div id="header">
                <div id="hgroups">
            ...
            <div id="contentWrapper" class="">
                ...
                <div id="content">
                    ...
                    <div class="col_main_in_withmenubar">
                        <div id="top_block_no_1"  ><div class="box"><div class="box_top" id="block_title_no_1"><h2>Invite People</h2></div><div style="clear:both"></div><div class="box_mid"><div class="content" id="block_no_1">
                                        <div class="tabs10Cont special_bg special_text special_border">
                                            <ul id="tabSet2">
                                                ...
                                                function change_preview() {
                                                    ...
                                                    document.getElementById('preview_email').innerHTML = invite_text;
                                                        ...
                                                        <table id="invitePreviewMail" cellpadding="0" cellspacing="0" border="0" width="620">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" style="background-color:#fff;border-bottom:1px solid #ccc;border-left:1px solid #ccc;border-right:1px solid #ccc;font-family:'lucida grande', tahoma, verdana, arial, sans-serif;padding:15px" valign="top"><table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="100%" style="font-size:12px" valign="top" align="left"><table cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                                                                                            <tbody>
                                                                                                <tr valign="top">
                                                                                                    <td width="100px;" style="padding-right:10px"><table cellspacing="0" cellpadding="0" width="100px" style="border-collapse:collapse">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td><a href="#" target="_blank"><img src="http://LoLcodex.com/avatars/b/avatar208.png" width="100" style="border:0"></a></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td style="font-size:11px;color:#666666;padding:5px 2px"><div>
                                                                                                                            <div><?PHP if($_GET['summ'] == NULL) print "Please associate a Summoner name"; else print $_GET['summ']; ?> </div>
                                                                                                                            <div><div> </div></div>
                                                                                                                        </div></td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table></td>
                                                                                                    <td width="100%" style="font-size:11px"><table cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                                                                                                            <tbody>
                                                                                                                <tr valign="top">
                                                                                                                ...
                                                                                                                <tr valign="top">
                                                                                                                    <td><table cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;width:100%">
                                                                                                                            <tbody>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td style="padding:10px 0px; font-size:11px"> Thanks,<br>
                                                                                                                        <?PHP if($_GET['summ'] == NULL) print "Please associate a Summoner name"; else print $_GET['summ']; ?></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td><table cellpadding="0" style="margin-top:5px">
                                                                                                                                            <tbody>
                                                                                                                                                <tr valign="top">
                                                                                                                                                    ...
                                                                                                                                                    <td style="font-size:11px;color:#999;padding:0px 0px 10px 0px"><span style="font-size:11px;color:#3B5998"><?PHP if($_GET['summ'] == NULL) print "Please associate a Summoner name"; else print $_GET['summ']; ?></span><br>us <img src="http://com/images/nations/us.gif"></td>
                                                                                                                                                </tr>
                                                                                                                                            </tbody>
                                                                                                                                        </table></td>
                                                                                                                                </tr>
                                                    ...
                                                    </div></p><p><br /><input type="submit" value="Submit" /></p></form></div><div id="tab_invite_watch_settings-content" class="panel special_text special_bg_reverse special_border" style="clear: both; display: none;"><span>There are no sent invitation at this time!</span></div></div></div></div><div class="box_bottom"><span class="box_bottom_right"></span><span class="box_bottom_left"></span></div></div>
                        </div>
                    </div>
                </div>
