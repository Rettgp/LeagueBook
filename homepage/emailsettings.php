...
<div id="top_block_no_3"  ><div class="box_mid_ops"><div class="content" id="block_no_3">    <div class="menu_list">
    <a style="background-image: url(http://grou.ps/images/fugue/user--pencil.png)"  href="http://LoLcodex.grou.ps/myprofile">Edit My Profile</a>
    <!--<a style="background-image: url(http://grou.ps/images/fugue/gear.png)"  href="http://LoLcodex.grou.ps/preferences">Preferences</a>-->
    <a style="background-image: url(http://grou.ps/images/fugue/lock.png)"  href="http://LoLcodex.grou.ps/password">Change Credentials</a>
    <a style="background-image: url(http://grou.ps/images/fugue/wall--pencil.png)"  href="http://LoLcodex.grou.ps/privacy_settings">Privacy Settings</a>
    <a style="background-image: url(http://grou.ps/images/fugue/mail--plus.png)"  href="http://LoLcodex.grou.ps/compose_message">Compose New Message</a>
    <a style="background-image: url(http://grou.ps/images/fugue/mail--pencil.png)"  href="http://LoLcodex.grou.ps/email_settings">E-mail Settings</a>
    <a style="background-image: url(http://grou.ps/images/fugue/mails-stack.png)"  href="http://LoLcodex.grou.ps/messages">My Incoming Messages</a>
    <a style="background-image: url(http://grou.ps/images/fugue/user--plus.png)"  href="http://LoLcodex.grou.ps/spread">Invite People!</a>
...
<div id="top_block_no_1"  ><div class="box"><div class="box_top" id="block_title_no_1"><h2>Email Settings</h2></div><div style="clear:both"></div><div class="box_mid"><div class="content" id="block_no_1"><form method="POST" action="http://grou.ps/lolcodex.com/dashboard/email_settings" class="siteForm"><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Private Messages</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="private_message" id="private_message_0" value="Y" checked /> <label for="private_message_0"> Yes</label>&nbsp;      <input type="radio" name="private_message" id="private_message_1" value="N"  /> <label for="private_message_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Group Invitation Mails</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="group_invite" id="group_invite_0" value="Y" checked /> <label for="group_invite_0"> Yes</label>&nbsp;      <input type="radio" name="group_invite" id="group_invite_1" value="N"  /> <label for="group_invite_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Friendship Requests</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="friend_request" id="friend_request_0" value="Y" checked /> <label for="friend_request_0"> Yes</label>&nbsp;      <input type="radio" name="friend_request" id="friend_request_1" value="N"  /> <label for="friend_request_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Event Notifications</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="event_invite" id="event_invite_0" value="Y" checked /> <label for="event_invite_0"> Yes</label>&nbsp;      <input type="radio" name="event_invite" id="event_invite_1" value="N"  /> <label for="event_invite_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Forum Notifications</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="talks_mail" id="talks_mail_0" value="Y" checked /> <label for="talks_mail_0"> Yes</label>&nbsp;      <input type="radio" name="talks_mail" id="talks_mail_1" value="N"  /> <label for="talks_mail_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Blog Notifications</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="blogs_mail" id="blogs_mail_0" value="Y" checked /> <label for="blogs_mail_0"> Yes</label>&nbsp;      <input type="radio" name="blogs_mail" id="blogs_mail_1" value="N"  /> <label for="blogs_mail_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Photos Notifications</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="photos_mail" id="photos_mail_0" value="Y" checked /> <label for="photos_mail_0"> Yes</label>&nbsp;      <input type="radio" name="photos_mail" id="photos_mail_1" value="N"  /> <label for="photos_mail_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Wiki Notifications</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="wiki_mail" id="wiki_mail_0" value="Y" checked /> <label for="wiki_mail_0"> Yes</label>&nbsp;      <input type="radio" name="wiki_mail" id="wiki_mail_1" value="N"  /> <label for="wiki_mail_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">Profile Viewers Notifications</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="profile_viewers" id="profile_viewers_0" value="Y" checked /> <label for="profile_viewers_0"> Yes</label>&nbsp;      <input type="radio" name="profile_viewers" id="profile_viewers_1" value="N"  /> <label for="profile_viewers_1"> No</label>   </div></div><div class="siteFormContainer">   <div class="siteFormTitle" style="width:250px !important">All Communications (includes plan warnings)</div>   <div class="siteFormBody" style="width:250px !important">      <input type="radio" name="dontemail" id="dontemail_0" value="Y" checked /> <label for="dontemail_0"> Yes</label>&nbsp;      <input type="radio" name="dontemail" id="dontemail_1" value="N"  /> <label for="dontemail_1"> No</label>   </div></div><div class="siteFormSubmit">   <div class="siteFormTitle" style="width:33%">&nbsp;</div>   <div class="siteFormBody" style="width:64%">       <input type="hidden" name="email_settings" value="1">       <input value="Save" type="submit">   </div></div></form></div></div></div><div class="box_bottom"><span class="box_bottom_right"></span><span class="box_bottom_left"></span></div></div>
</div>
</div>
        </div>
</div>
