...
<div id="top_block_no_1"  ><div class="box"><div class="box_top" id="block_title_no_1"><h2><div class="menu_list"><a href="http://LoLcodex.grou.ps/dashboard/compose_message">Compose New Message</a></div>Incoming Messages</h2></div><div style="clear:both"></div><div class="box_mid"><div class="content" id="block_no_1">
 <style>
 ...
 #newsfeed_filters { display: none; }
    ...
    <div id="newsfeed">
        ...
        <div id="emptyContent">
          <div class="emptyModuleIcon" style="background-position: -1280px 0;;"></div>
          <div class="emptyModuleText">

            <h3>There are no messages here.</h3><p>Why not create a new message?</p></div>
     </div>
