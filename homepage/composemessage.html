...
<div id="content">
<div class="col_menu" id="col_sidebar">
...
<div id="top_block_no_1"  ><div class="box"><div class="box_top" id="block_title_no_1"><h2>Compose Message</h2></div><div style="clear:both"></div><div class="box_mid"><div class="content" id="block_no_1"><form method="post" class="siteForm" id="multiMessageForm">
            <div class="siteFormContainer">
        <div class="siteFormTitle">Your Friends:</div>
        <div class="siteFormBody">
            <!--input class="large people_selector_filter" name="to" type="text" /-->
            <!--div class="siteFormSubText">Type your friends' name</div-->

            <input type="text" id="messageTo" name="messageTo" value="" />
   <br />
   <p><a href="#" onclick="$('messageToEmail').show();this.style.display='none';">Need to add email addresses as well for people outside this network?</a>
   <input type="text" id="messageToEmail" name="messageToEmail" value="" placeholder="Enter emails here... Separate by comma." class="medium" style="display:none;"  /></p>
        </div>
    </div>
    <div class="siteFormContainer">
        <div class="siteFormTitle">Your Message:</div>
        <div class="siteFormBody">
            <textarea class="large" name="body"></textarea>
            <div class="siteFormSubText"></div>
        </div>
    </div>
    <div class="siteFormSubmit">
        <div class="siteFormTitle">&nbsp;</div>
        <div class="siteFormBody">
            <input type="hidden" name="sendMessageForm" value="1" />
            <input type="button" name="send" id="messageSendButton" value="Send Message" onclick="this.value='Sending Message'" />
        </div>
    </div>
