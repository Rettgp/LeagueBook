...
<div id="top_block_no_1"  ><div class="box"><div class="box_top" id="block_title_no_1"><h2>Change My Password</h2></div><div style="clear:both"></div><div class="box_mid"><div class="content" id="block_no_1"><form method="POST" action="http://grou.ps/LoLcodex/password/change_password" class="siteForm">                    <div class="siteFormContainer">
                    ...
                    <div class="siteFormContainer">
                        <div class="siteFormTitle">New Password</div>
                        <div class="siteFormBody">    
                            <input onfocus="inputfocus(this)" onblur="inputblur(this)" type="password" name="newpassword1" size="40" />
                        </div>
                    </div>
                    <div class="siteFormContainer">
                        <div class="siteFormTitle">Confirm New Password</div>
                        <div class="siteFormBody">    
                            <input onfocus="inputfocus(this)" onblur="inputblur(this)" type="password" name="newpassword2" size="40" />
                        </div>
                    </div>                                        
                    <div class="siteFormSubmit">
                       <div class="siteFormTitle">&nbsp;</div>
                       <div class="siteFormBody">
                           <input type="submit" value="Change My Password" /> &nbsp; <a href="javascript:;" onclick="$('hidden_block_2').show();"><small>Need to change email address?</small></a>
                       </div>
                    </div>
...
<div id="hidden_block_2"  style="display:none"  ><div class="box"><div class="box_top" id="block_title_no_2"><h2>Change My Email</h2></div><div style="clear:both"></div><div class="box_mid"><div class="content" id="block_no_2"><form method="POST" action="http://grou.ps/LoLcodex/password/change_email" class="siteForm">                    <div class="siteFormContainer">
                    ...
                    <div class="siteFormContainer">
                        <div class="siteFormTitle">New Email</div>
                        <div class="siteFormBody">    
                            <input onfocus="inputfocus(this)" onblur="inputblur(this)" type="text" name="newemail" size="40" />
                        </div>
                    </div>                                       
                    <div class="siteFormSubmit">
                       <div class="siteFormTitle">&nbsp;</div>
