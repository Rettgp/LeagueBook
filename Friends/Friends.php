...
<html dir="ltr">
    <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="RSS" href="http://com/rss/LoLcodex/people">
        ...
        <div id="layout" class="module_people_v2 ">
            ...
            <div id="contentWrapper" class="">
                ...
                <div id="content"><div class="col_full">
                        <div id="top_block_no_1"  ><div class="box"><div class="box_top" id="block_title_no_1"><h2>		<form method="POST" action="http://LoLcodex.com/people" style="display:none;" id="rank_type_form">
                                            ...
                                            function rank_people_by(w) {
                                                switch(w) {
                                                    ...
                                                    case 'activity':
                                                        ...
                                                        break;
                                                    default:
                                                        window.location.href = 'http://LoLcodex.com/people';
                                                        break;
                                                }
                                            }
                                        </script>
                                        <div class="menu_list" id="block_title_sub_menu">
                                            ...
                                            <a href="http://LoLcodex.com/people/member_search">Search</a>
                                        ...
                                        <table id="people_container" class="thumbnail_view vertical_top"><tr>
                                                ...
                                                <td width="190">
                                                    <a href="http://LoLcodex.com/people/oajiivhbldxbldhwi" title="<?PHP if($_SESSION['summoner'] == NULL) print "Please associate a Summoner name"; else print $_SESSION['summoner']; ?> is online">
                                                        <span class="tv_caption online_people_icon"><?PHP if($_SESSION['summoner'] == NULL) print "Please associate a Summoner name"; else print $_SESSION['summoner']; ?></span></a>
                                                    <span class="tv_info">
